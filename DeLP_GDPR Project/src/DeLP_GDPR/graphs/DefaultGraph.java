...
public class DefaultGraph<T extends Node> implements Graph<T> {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see DeLP_GDPR.graphs.Graph#add(DeLP_GDPR.graphs.Node)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see DeLP_GDPR.graphs.Graph#iterator()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see DeLP_GDPR.graphs.Graph#contains(java.lang.Object)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see DeLP_GDPR.graphs.Graph#areAdjacent(DeLP_GDPR.graphs.Node,
	 * DeLP_GDPR.graphs.Node)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see DeLP_GDPR.graphs.Graph#getEdge(DeLP_GDPR.graphs.Node,
	 * DeLP_GDPR.graphs.Node)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see DeLP_GDPR.graphs.Graph#existsDirectedPath(DeLP_GDPR.graphs.Node,
	 * DeLP_GDPR.graphs.Node)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see DeLP_GDPR.graphs.GeneralGraph#getSubgraphs()
	 */
