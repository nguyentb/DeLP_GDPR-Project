...
import DeLP_GDPR.dung.reasoner.SimpleGroundedReasoner;
import DeLP_GDPR.dung.reasoner.SimplePreferredReasoner;
import DeLP_GDPR.dung.reasoner.SimpleStableReasoner;
import DeLP_GDPR.dung.semantics.*;
import DeLP_GDPR.graphs.*;
import DeLP_GDPR.math.matrix.Matrix;
import DeLP_GDPR.math.term.IntegerConstant;
...
public class DungTheory extends BeliefSet<Argument,DungSignature> implements Graph<Argument>, Comparable<DungTheory>, ArgumentationFramework<Argument> {
	...
	/* (non-Javadoc)
	 * @see DeLP_GDPR.graphs.Graph#getRestriction(java.util.Collection)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see DeLP_GDPR.graphs.Graph#add(DeLP_GDPR.graphs.Edge)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see DeLP_GDPR.graphs.Graph#getNodes()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see DeLP_GDPR.graphs.Graph#getNumberOfNodes()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see DeLP_GDPR.graphs.Graph#areAdjacent(DeLP_GDPR.graphs.Node, DeLP_GDPR.graphs.Node)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see DeLP_GDPR.graphs.Graph#getEdges()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see DeLP_GDPR.graphs.Graph#getChildren(DeLP_GDPR.graphs.Node)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see DeLP_GDPR.graphs.Graph#getParents(DeLP_GDPR.graphs.Node)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see DeLP_GDPR.graphs.Graph#existsDirectedPath(DeLP_GDPR.graphs.Node, DeLP_GDPR.graphs.Node)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see DeLP_GDPR.graphs.Graph#getNeighbors(DeLP_GDPR.graphs.Node)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see DeLP_GDPR.graphs.Graph#getAdjancyMatrix()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see DeLP_GDPR.graphs.Graph#getComplementGraph(int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see DeLP_GDPR.graphs.Graph#hasSelfLoops()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see DeLP_GDPR.graphs.Graph#getEdge(DeLP_GDPR.graphs.Node, DeLP_GDPR.graphs.Node)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see DeLP_GDPR.graphs.Graph#isWeightedGraph()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see DeLP_GDPR.graphs.Graph#getStronglyConnectedComponents()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see DeLP_GDPR.graphs.Graph#getSubgraphs()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see DeLP_GDPR.graphs.DefaultGraph#getComponents()
	 */
	/**
	 * 
	 * @return DefaultGraph
	...
	/* (non-Javadoc)
	 * @see DeLP_GDPR.graphs.DefaultGraph#getInducedSubgraphs()
	 */
	/**
	 * 
	 * @return DefaultGraph
